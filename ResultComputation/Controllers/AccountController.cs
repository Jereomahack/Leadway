    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    //check if user is in role Parent
                    ApplicationUser user = db.Users.FirstOrDefault(t => t.UserName == model.Email);
                    if (user.RoleName == "Parent")
                    {
                        return RedirectToAction("IndexParent", "Scores");
                    }
                    else
                    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string MailTopic = "Forgot Password";
                ...
                FromMail, model.Email, MailTopic, "Hello" + Environment.NewLine + Environment.NewLine
                + "Please Click on this Link below to Recover Your Password" + Environment.NewLine + Environment.NewLine + Environment.NewLine + callbackUrl
              );
